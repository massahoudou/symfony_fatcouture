 ...
 */
final class Version20200907160954 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP iduser_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE idproduit_id idproduit_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE contact ADD iduser_id INT DEFAULT NULL');
